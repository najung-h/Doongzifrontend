...
- (전세사기에 대한 높은 불안감) 응답자의 82.2%가 전세사기에 대해 '다소 불안'(64.3%), '극도롤 불안'(17.9%)하다고 답했습니다.
- (법률 및 서류 해석의 어려움)  계약 경험자 중 40%는 '어려운 법률 용어 및 문서 해석'을, 55%는 '계약서상 특약 사항(독소조항)의 유불리 판단'을 가장 큰 어려움으로 지적했습니다. 또한, 응답자의 62.1%는 등기부등본을 발급할 수는 있어도 위험 요소를 판단하기는 어렵다고 응답하며, 내용을 완벽히 이해하고 위험 요소를 찾아낼 수 있는 응답자는 13.8%에 불과하였습니다.
- (체계적 가이드 부재) 응답자의 72.4%는 모르는 용어가 나올 경우 '인터넷 검색'에 의존했으며, 응답자의 62.1%는 계약 과정에서 놓친 경험이 있거나 놓칠까 봐 걱정한 적이 있다고 답했습니다. 그러나, 응답자의 79.3%는 공공기관의 전세사기 예방 서비스를 있는 줄 몰라서 이용하지 못하였습니다.
- (AI 기반 솔루션에 대한 높은 수요) 응답자의 75.8%가 등기부등본 등 서류를 사진으로 올리면 위험도를 분석해주는 AI 서비스에 대해 이용하고 싶다는 반응을 보였습니다. 가장 필요한 기능으로는 '위험도 자동 분석'과 '독소조항 탐지'가 꼽혔습니다.